require("plenary.reload").reload_module("monokai", true)
local monokai = require("monokai")
local default = monokai.config

describe("setup", function()
  it("works with default values", function()
    monokai.setup()
    assert.are.same(monokai.config, default)
  end)
  ...
  it("works with old italic values", function()
    ...
    monokai.setup({ italic = true })
    assert.are.same(monokai.config, expected)
  end)
  ...
  it("works with config overrides", function()
    ...
    monokai.setup({ undercurl = false, underline = false })
    assert.are.same(monokai.config, expected)
  end)
end)
